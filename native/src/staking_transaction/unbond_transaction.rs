...
use chain_core::state::account::{Nonce, StakedStateAddress, StakedStateOpAttributes, StakedStateOpWitness, UnbondTx};
use chain_core::tx::TransactionId;
use parity_scale_codec::{Decode, Encode};

use super::tx_aux::tx_aux_to_hex;
...
pub fn unbond_tx_argument(ctx: &mut FunctionContext, i: i32) -> NeonResult<UnbondTx> {
