...
export class WithdrawUnbondedTransactionBuilder extends TransactionBuilder {
    ...
    private witness?: Buffer;

    /**
     * Creates an instance of WithdrawUnbondedTransactionBuilder.
     * @param {WithdrawUnbondedTransactionBuilderOptions} [options] Builder options
    ...
    public sign(keyPair: KeyPair): WithdrawUnbondedTransactionBuilder {
        ...
        this.witness = native.stakingTransaction.withdrawUnbondedTransactionToWitness(
            this.unsignedRawTx,
            keyPair.toObject(),
        );
    ...
    /**
     * Add signature to the builder
     *
     * @param {Buffer} witness Signature in Buffer
     * @memberof WithdrawUnbondedTransactionBuilder
     */
    public addWitness(witness: Buffer): WithdrawUnbondedTransactionBuilder {
        ow(witness, 'witness', owStakedStateOpWitness);
    ...
    /**
     * Returns witness
     * @returns {Buffer} transaction witness
     * @memberof WithdrawUnbondedTransactionBuilder
     */
    public getWitness(): Readonly<Buffer> {
        if (!this.isSigned()) {
