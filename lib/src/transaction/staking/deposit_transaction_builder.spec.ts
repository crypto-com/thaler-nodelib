    ...
    describe('txId', () => {
        ...
        it('should return transaction id in string', () => {
            ...
            expect(builder.txId()).to.eq(
                '863e5b36f5137b9b36797d41ecda72cda7c1ba1c1fb419da81d39fea7f94cb0a',
            );
        });
    });
    ...
    describe('toHex', () => {
        ...
        it('should return completed Hex', () => {
            ...
            expect(txHex.toString('hex')).to.deep.eq(
                '',
            );
        });
