...
import { owBigNumber, owTransferAddress } from '../types';
...
const owLinearFeeMilli = owBigNumber.validate((value: object) => ({
    validator: (value as BigNumber).isGreaterThanOrEqualTo(0),
