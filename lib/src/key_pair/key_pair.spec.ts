...
describe('KeyPair', () => {
    ...
    describe('fromPublicKey', () => {
        ...
        it('should return KeyPair with the provided public key', () => {
        ...
        it('should return KeyPair with the provided compressed public key', () => {
            const compressedKey = validCompressedPublicKey();
            const expectedPublicKey = validPublicKey();
            const keyPair = KeyPair.fromPublicKey(compressedKey);
